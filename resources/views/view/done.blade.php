		...
		<div class="section">
			<div class="detail">
				<div class="container">
					<div class="row">
						<div class="col-md-12">
							<div class="col-md-4 col-sm-4 pb30">
								<div class="row">
									<div class="col-md-12 dp p20">
										<h4 class="text-center ttY p10 Br"> Your Reservation</h4>
										<div class="">
											<p class="cfcs">Price Breakdown</p>
											<p><em class="cfc fmtt">Room : 4 Beds Mixed Dorm with private bathroom and bathtub</em> <span class="pull-right cfcs fmtt">$7.00</span></p>
											<p class="text-center fmt co">
												Guest 1
											</p>
											<div class="dvdres "></div>
											<p class="f17 cf1">
												Total 
											...
											<p class="f17 cf1">
												Vat 8% 
												<span class="pull-right">$0.56</span>
											</p>
											<div class="dvdres"></div>
											<h4 class="fmt cfcs">
												Grand Total 
												<span class="pull-right">$7.56</span>
											</h4>
										</div>
									</div>
								</div>
							...
							<div class="col-md-8 col-sm-8 ">
								<div class="row">
									<div class="col-md-12 text-left mgb10 visible-lg visible-md visible-sm">
							            		<ul class="breacrumb">
							              			<li class="tab">1. Date</li>
									              	<li class="tab">2. Room</li>
									              	<li class="tab">3. Reservation</li>
									              	<li class="tab active-tab">4. Confirmation</li>
							             		</ul>
							          		</div>
									...
									<div class="col-md-12" >
										<div class="bgS p240" >
											<h3 class="cht">Reservation Completed!</h3>
											<p class="chp">
												Your reservation details have just been sent to your email. If you have any question, please don't hesitate to contact us. Thank you!
											</p>
											<p class="chp">
												vovehosteldanang@gmail.com
											</p>
										</div>
									</div>
								</div>
