...
<body>
	...
	<div id="container">
				...
				<div class="container">
					...
					<div class="navbar-collapse collapse">
						<ul class="nav navbar-nav navbar-right">
							...
							<li><a class="active" href="/room">Room</a></li>
	          			...
	          			<div class="room-img">
	                    			...
	                    			<div class="room-title">
	                    				<div class="visible-lg visible-md visible-sm">
	                    					<h3 class="mdH">ROOMS</h3>
	                    					<p class="mdP">Captions line here</p>
	                    				</div>
	                    				<div class="visible-xs">
	                    					<h3 class="mgb xsH">ROOMS</h3>
		...
		<div class="room">
			<div class="container">
				<div class="row">
					<div class="col-md-12 col-xs-12 pdt30">
						<div class="col-md-9 col-xs-12">
							<div class="rooms-img">
								<a href="/detailroom">
									<img src="http://backpackhostel.net/wp-content/uploads/2015/08/doubleroom-750x330.jpg" class="w100" >
								</a>
							</div>
							<div>
								<a class="room-text" href="/detailroom"><h4>PRIVATE DOUBLE ROOM WITH PRIVATE BATHROOM AND BATHTUB</h4></a>
								<a class="room-link" href="/detailroom">Check Details 
									<i class="fa fa-long-arrow-right icon-long-arrow-right mgl10"></i>
								</a>
							</div>
						</div>
					</div>
					<div class="col-md-12 col-xs-12 pdt30">
						<div class="col-md-9 col-xs-12">
							<div class="rooms-img">
								<a href="/detailroom">
									<img src="http://backpackhostel.net/wp-content/uploads/2015/08/2beds-750x330.jpg" class="w100" >
								</a>
							</div>
							<div>
								<a class="room-text" href="detailRoom.html"><h4>PRIVATE DOUBLE ROOM WITH PRIVATE BATHROOM AND BATHTUB</h4></a>
								<a class="room-link" href="/detailroom">Check Details 
									<i class="fa fa-long-arrow-right icon-long-arrow-right mgl10"></i>
								</a>
							</div>
					...
					<div class="col-md-12 col-xs-12 pdt30">
						<div class="col-md-9 col-xs-12">
							<div class="rooms-img">
								<a href="/detailroom">
									<img src="http://backpackhostel.net/wp-content/uploads/2015/08/3beds-750x330.jpg" class="w100" >
								</a>
							</div>
							<div>
								<a class="room-text" href="/detailroom"><h4>PRIVATE DOUBLE ROOM WITH PRIVATE BATHROOM AND BATHTUB</h4></a>
								<a class="room-link" href="detailRoom.html">Check Details 
									<i class="fa fa-long-arrow-right icon-long-arrow-right mgl10"></i>
								</a>
							</div>
						</div>
